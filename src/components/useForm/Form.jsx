...
import { Link, Outlet, useParams, useHistory, useNavigate } from "react-router-dom"
...
function Form() {
    ...
    const {
        ...
        } : { name: "", RollNo: "", Select: "", Gender: false, Subject: [false, false], file: null }
    })
